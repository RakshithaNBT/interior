...
export default function LoadingScreen() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleSkip}
        className="absolute bottom-6 right-10 md:bottom-[40px] md:right-[122px] z-50 flex items-center rounded-full border border-white/20 bg-black/30 p-4 backdrop-blur-md shadow-[0_4px_20px_rgba(0,0,0,0.6)] transition-all duration-500 hover:bg-black/60 hover:border-[var(--gold)] hover:shadow-[0_0_30px_rgba(201,169,110,0.4)] group cursor-pointer"
      >
